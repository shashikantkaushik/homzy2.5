          ...
          Expanded(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  Text("Service", style: TextStyle(fontSize: 40, color: Colors.black54),),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text('Rs.150', style: TextStyle(color: Colors.black54,fontSize: 30),),
                    ],
                  ),
                    ...
                    child: ElevatedButton(
                      ...
                      child:  Row(
                        ...
                        children: [
                          ...
                          Text('Book', style: TextStyle(fontSize: 20, color: Colors.black),),
                        ],
                      ),
                    ),
                  ),
